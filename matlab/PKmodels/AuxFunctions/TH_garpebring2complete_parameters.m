function [param_complete,K,label_out]=TH_garpebring2complete_parameters(par_matrix)
% [parametry,K,label_out]=TH_garpebring2complete_parameters(par_matrix)
% input:
%   par_matrix=[Fp vp ve PS tau] - original values
% output:
...
%     if nargout>1 - derivace pro TH_Garpebring nejsou spocitane
